...
onMounted(async () => {
  ...
  if (!code) {
    ...
    error("Xatolik", "OneID dan authorization code kelmadi")
  ...
  try {
    ...
    if (authStore.isAuthenticated) {
      ...
      errorMessage.value = "Autentifikatsiya amalga oshmadi"
      error("Xatolik", "OneID orqali kirish muvaffaqiyatsiz bo'ldi")
      setTimeout(() => router.push("/login"), 2000)
    }
  } catch (err: any) {
    const msg = err.response?.data?.message || "OneID orqali kirish xatosi"
    ...
    <div class="relative z-10 text-center">
      ...
      <div v-if="loading" class="flex flex-col items-center gap-6">
        ...
        <p class="text-white text-xl font-semibold">
          OneID orqali kirish amalga oshirilmoqda...
        </p>
